module.exports = {
  ...
  placeholderName: 'EMKTProjectName',
  ...
  // Template directory should have package.json with all dependencies specified, including `react-native`.
  templateDir: './',

  // Path to script, which will be executed after initialization process,
  // but before installing all the dependencies specified in the template.
  // This script runs as a shell script but you can change that
